...
export default function LogEvent({ onFormSubmit }) {
  ...
  const [formData, setFormData] = useState({
    ...
    royalty_percentage_to_artist: 0,
  });
  ...
  return (
    <div className="container">
      ...
      >
        ...
        <div className="col-md-6">
          <label htmlFor="royalty_receiver_address" className="form-label">
            Royalty Receiver Address
          </label>
          <input
            type="text"
            className="form-control"
            id="royalty_receiver_address"
            value={formData.royalty_receiver_address}
            onChange={handleInputChange}
          />
        </div>

        <div className="col-md-6">
          <label htmlFor="royalty_percentage_to_artist" className="form-label">
            Royalty Percentage to Artist
          </label>
          <input
            type="number"
            className="form-control"
            id="royalty_percentage_to_artist"
            value={formData.royalty_percentage_to_artist}
            onChange={handleInputChange}
          />
        </div>
